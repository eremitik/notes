...
=# select * FROM students WHERE date_of_birth BETWEEN ‘1996-06-30’ AND now();
...
=# SELECT * FROM checkins INNER JOIN students ON students.id = checkins.student_id;
=# SELECT * FROM checkins INNER JOIN students ON students.id = checkins.student_id WHERE checked_in_at BETWEEN ‘2016-06-01’ AND ‘2016-06-30’;
